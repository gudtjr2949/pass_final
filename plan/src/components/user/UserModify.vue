  ...
  <div class="modify-container">
    <div class="modify-form">
      ...
      <div class="form-group">
        ...
        <input type="password" id="user_pw" v-model="user.user_pw" />
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="email-domain-container">
          <input type="text" id="user_email" v-model="user.user_email" />
          <span class="at-symbol">@</span>
          <input type="text" id="user_domain" v-model="user.user_domain" />
        </div>
      </div>
      <div>
